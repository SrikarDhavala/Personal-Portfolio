...
import { FaCss3, FaHtml5, FaJs, FaPython, FaReact, FaGitAlt  } from "react-icons/fa"
import { SiMongodb, SiTailwindcss, SiFastapi } from "react-icons/si"
...
export default function Skills(){
    ...
    const skills = [
        ...
        {icon: <PiMicrosoftPowerpointLogoDuotone />, name: "PowerPoint"},
    ...
    return(
        <section id="skills" ref={sectionRef} className="h-1/2 w-full pb-8 flex flex-col items-center justify-center relative bg-black text-white overflow-hidden">
            ...
            <motion.h2 className="text-4xl mt-5 py-1 sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] z-10" initial={{opacity: 0, y: -30}} whileInView={{opacity: 1, y: 0}} transition={{duration: 0.5, delay: 0.1}}>
                My Skills
            </motion.h2>
            ...
            <div className="relative w-full overflow-hidden">
                <motion.div ref={trackRef} className="flex mt-2 mb-2 gap-10 text-6xl text-[#1cd8d2]" style={{x, whiteSpace: "nowrap", willChange:"transform"}}>
                    {repeated.map((s, i) => (
